...
Date: 2017/01/09
Description:
	se modfiica el SP ccsp_RIA_ABCAgents para que el registro de usuarios acepte los 20 caracteres del nombre de usuario
	se modfiica el SP ccsp_RIAChecaLogin para que el login de agente acepte los 20 caracteres del nombre de usuario
	se modfiica el SP ccsp_RIAADMChecaLogin para que el login de administrador acepte los 20 caracteres del nombre de usuario
