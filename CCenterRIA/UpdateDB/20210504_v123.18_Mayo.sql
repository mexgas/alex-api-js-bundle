...
set nocount off'
	...
	set @process = 'CW-5084 Desactivar la validacion de telefono en llamada manual'	
...
'
	...
	set @sql = '
	if exists (select * from sys.procedures where name = N''ccspAgent_GetLastCalls'')
    begin
    ...
    set @process = 'CW-5189 Se creo la consulta para obtener los datos de los ACD del dÃ­a'	
	set @sql = '
	...
	BEGIN
		...
		if(@Option = 3) -- Obtiene los datos de las llamadas de todos los ACD, datos que se muestran en el tablero de informaciÃ³n del administrador 
	    begin
			SELECT 
...
set nocount off'
	...
	set @process = 'CW-3996 Habilitar captura de los 5 datos en ACD con reprogramaciÃ³n'	
