...
END;'
		...
		set @process = 'CW-7099 Create procedure ccsp_ConversationWASave'
					    ...
					    BEGIN --new Conversation
					        ...
					        BEGIN
					           ...
					           , agentId
								...
								--EXEC ccsp_WhatsAppOperatingSummary @Option = 1, @InboundId = @inboundId;
							...
							BEGIN --register desconnection by conversationID
								...
								BEGIN  
								   ...
								   IF @conversationStatus = 17 OR @conversationStatus = 18 BEGIN --Save conversation Ended by system
										...
										--EXEC ccsp_WhatsAppOperatingSummary @Option = 3, @InboundId = @inboundId;
								   END
								   exec ccsp_CreateNodeMultimedia @conversationId=@conversationIdTemp, @type=5
								   SET @counter += 1;
								END
							...
							ELSE BEGIN
								...
								IF @conversationStatus = 13 BEGIN
									...
									IF NOT EXISTS (SELECT NumberClient from ccWhatsAppSpam where NumberClient = @clientId) BEGIN
										...
										END
								END
								ELSE IF @conversationStatus = 10 OR @conversationStatus = 17 OR @conversationStatus = 18 BEGIN --Save conversation Ended by system
