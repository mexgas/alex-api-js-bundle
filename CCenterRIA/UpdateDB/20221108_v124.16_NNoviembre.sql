		...
		(
		   select top 1 * from ccSettings where descripcion = ''Máximo de imágenes que se pueden enviar por el Chat''
			...
			BEGIN
				...
				243,
				10,
				''Máximo de imágenes que se pueden enviar por el Chat'',
				1,
				''GRL'',
				''Valor indica el máximo de imágenes permitidas para enviar por el chat en cada una de sus acciones.'',
				''Maximum number of images that can be sent via Chat'',
				0,
				''.*''
				)
			END';
