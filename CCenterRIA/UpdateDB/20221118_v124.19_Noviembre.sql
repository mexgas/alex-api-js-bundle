...
BEGIN
	...
	SET @process = 'KR061003 Agregando estado de email 36 en ccTipoStatusAgente'
		...
		IF NOT EXISTS(SELECT * FROM ccTipoStatusAgente WHERE TipoStatusAge_id=36)
			BEGIN
			INSERT INTO [CCenterRIA].[dbo].[ccTipoStatusAgente] VALUES(36, ''Dialogo Email'');
			END
		'

		EXEC(@sql)

	SET @process = 'KR061003 Agregando estado de email 36 en configuraIdiomaCatalogosEnglish'
		SET @sql = '
		ALTER PROCEDURE [dbo].[configuraIdiomaCatalogosEnglish]
		AS SET NOCOUNT ON
		...
		SET @process = 'KR061003 Agregando estado de email 36 en configuraIdiomaCatalogosEspañol'
		SET @sql = '
		ALTER PROCEDURE [dbo].[configuraIdiomaCatalogosEspañol] AS
		SET NOCOUNT ON
		...
		SET @process = 'KR061003 Agregando estado de email 36 en configuraIdiomaCatalogosPortugues'
		SET @sql = '
		ALTER PROCEDURE [dbo].[configuraIdiomaCatalogosPortugues]
		AS SET NOCOUNT ON
