...
BEGIN
	...
	BEGIN TRY
		...
		SET @process = 'K038017-Carga BD-Servicio IA actualiza cal_fecha en ccoCallsOutSource CCenterRia alter SP ccsp_GalateaArtificialIntelligence'
