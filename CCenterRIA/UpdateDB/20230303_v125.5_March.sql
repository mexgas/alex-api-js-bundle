...
BEGIN
	...
	SELECT dialPrefixMan DialPrefixMan, dialPrefixXfe DialPrefixXfe, listenManualCall 
		...
		AllowFileAttachments, @numbers AS FreeNumbers
	FROM @AllCampaigns
	WHERE cam_id = @campID
END
'
...
'
		...
		SET @process = 'ccsp_MultimediaConfigurations se opcion 4 para obtener el numero de wa asiciado a la campaña'
		...
		SET @process = 'SP ccsp_RIAUpdateCamConfig - Se desasoica la campaña de salida de la tabla ccWhatsAppNumbers'
