...
BEGIN
	...
	---------------------------------------BEGIN Marco Garcia & Marco Chagolla K039000 Destinatario de grabaciones (envÃ­o de grabaciones en finder a correos dados de alta en el sistema)---------------------------------------------------------

SET @process = 'K039000 Destinatario de grabaciones (envÃ­o de grabaciones en finder a correos dados de alta en el sistema) update lenght  of email column in ccsp_RIA_AddressBook table'
SET @sql = 'IF exists
	(
	SELECT *
	...
	SET @process = 'K039000 Destinatario de grabaciones (envÃ­o de grabaciones en finder a correos dados de alta en el sistema) delete store procedure ccsp_RIA_AddressBook'
...
SET @process = 'K039000 Destinatario de grabaciones (envÃ­o de grabaciones en finder a correos dados de alta en el sistema) create store procedure [ccsp_RIA_AddressBook]'
SET @sql = 'CREATE PROCEDURE [dbo].[ccsp_RIA_AddressBook]
	...
	---------------------------------------END Marco Garcia & & Marco Chagolla K039000 Destinatario de grabaciones (envÃ­o de grabaciones en finder a correos dados de alta en el sistema)-----------------------------------------------------------
...
EXEC(@sql)
-------------------------------------------- END Roberto Nava -------------------------------------------------------		/* End script release */
