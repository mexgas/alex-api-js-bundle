...
EXEC(@sql)
-------------------------------------------BEGIN MACL CW-8033------------------------------------------------
SET @process = 'Se inserta etiquetas faltantes a la tabla tableLangueDbLoader'
...
SET @process = 'ALTER Sp ccsp_RIALogPhones se agrega condición para cuando sea tipoMov = 2'
