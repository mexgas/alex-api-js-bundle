...
----------------------------------------------------------------------------------- Begin Jesus Gallardo Fix/125.20231211.0.11 --------------------------------------------------------------------------
        SET @process = 'Alter Sp ccsp_InsertDNCList Se parametriza las consultas'
...
IF @dropTmpPhone IS NOT NULL EXEC (@dropTmpPhone);'
        ...
        SET @sql = ''
        EXEC(@sql);
---------------------------------------------------------------------------------- END Jesus Gallardo Fix/125.20231211.0.11 --------------------------------------------------------------------------
