...
SET @process = 'K061001 Actualizaciones en ccStatusLLamada - sp configuraIdiomaCatalogosEspañol'
...
SET @process = 'K061001 Actualizaciones en ccStatusLLamada - sp configuraIdiomaCatalogosEnglish'
...
SET @process = 'K061001 Actualizaciones en ccStatusLLamada - sp configuraIdiomaCatalogosPortugues'
...
SET @process = 'K061001 Actualizaciones en ccStatusLLamada - sp configuraIdiomaCatalogosPortugues'	
SET @sql='DECLARE @language INT; 
	select @language = valor from ccSettings where setting_id = 27; 
	if @language = 0 
	begin 
		update ccStatusLLamada set descripcion = ''Fuera de horario'' where statusCall_id = 2
		update ccStatusLLamada set descripcion = ''Fuera de servicio'' where statusCall_id = 3
		update ccStatusLLamada set descripcion = ''Sin agentes conectados'' where statusCall_id = 4
		update ccStatusLLamada set descripcion = ''Abandonada'' where statusCall_id = 6
		update ccStatusLLamada set descripcion = ''Desbordada (tiempo de espera excedido)'' where statusCall_id = 7
		update ccStatusLLamada set descripcion = ''Desbordada (número en espera excedido)'' where statusCall_id = 8
		update ccStatusLLamada set descripcion = ''Asignada en falla'' where statusCall_id = 11
		update ccStatusLLamada set descripcion = ''Atendida'' where statusCall_id = 13
		update ccStatusLLamada set descripcion = ''Asignada y perdida'' where statusCall_id = 15
		update ccStatusLLamada set descripcion = ''Asignada en tono de línea'' where statusCall_id = 16
	end
	if @language = 1
	begin 
		update ccStatusLLamada set descripcion = ''Out of schedule'' where statusCall_id = 2
		update ccStatusLLamada set descripcion = ''Out of service'' where statusCall_id = 3
		update ccStatusLLamada set descripcion = ''No online agents'' where statusCall_id = 4
		update ccStatusLLamada set descripcion = ''Overflow (wait time exceeded)'' where statusCall_id = 7
		update ccStatusLLamada set descripcion = ''Overflow (queue limit exceeded)'' where statusCall_id = 8
		update ccStatusLLamada set descripcion = ''Assigned on failure'' where statusCall_id = 11
		update ccStatusLLamada set descripcion = ''Cancelled Message'' where statusCall_id = 14
		update ccStatusLLamada set descripcion = ''Assigned and missed'' where statusCall_id = 15
		update ccStatusLLamada set descripcion = ''Assigned on dial tone'' where statusCall_id = 16
	end
	if @language = 2
	begin 
		update ccStatusLLamada set descripcion = ''Fora de horário'' where statusCall_id = 2
		update ccStatusLLamada set descripcion = ''Sem agentes conectados'' where statusCall_id = 4
		update ccStatusLLamada set descripcion = ''Abandonada'' where statusCall_id = 6
		update ccStatusLLamada set descripcion = ''Estourada (tempo de espera excedido)'' where statusCall_id = 7
		update ccStatusLLamada set descripcion = ''Estourada (limite da fila excedido)'' where statusCall_id = 8
		update ccStatusLLamada set descripcion = ''Atribuída em falha'' where statusCall_id = 11
		if exists (select * from ccStatusLLamada where statusCall_id = 12) update ccStatusLLamada set descripcion = ''Mensagem compareceram'' where statusCall_id = 12
...
SET @process = 'Update ccStatusLLamada set descTranslated'	
SET @sql='
	update ccStatusLlamada set descTranslated=''systemTranslated_status_abandon'' where statusCall_id=6
	update ccStatusLlamada set descTranslated=''systemTranslated_status_withMSSG'' where statusCall_id=9
	update ccStatusLlamada set descTranslated=''systemTranslated_status_assigned'' where statusCall_id=11
	update ccStatusLlamada set descTranslated=''systemTranslated_status_answered'' where statusCall_id=13
	update ccStatusLlamada set descTranslated=''systemTranslated_status_missed'' where statusCall_id=15
	update ccStatusLlamada set descTranslated=''systemTranslated_status_dialTone'' where statusCall_id=16
'
EXEC(@sql)
