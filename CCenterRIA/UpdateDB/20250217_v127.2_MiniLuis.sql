...
SET @process = 'Se agregan nuevas configuraciones al procedimiento de guardado ccsp_RIAConfCamp, Se agrega campo surveyCamId'
   ...
   SET @process = 'Se agregan nuevas configuraciones al procedimiento de guardado ccsp_GalateaGetOutboundConfiguration, se agrega surveyCamId y @ScriptVariables'
    SET @sql= '
    ...
    BEGIN
        ...
        ,ApplyRescheduledSurveyForCompletedCallsAI
        ,EnableCallRecordingAI
        ,@ScriptVariables AS ScriptVariables -- Nueva columna agregada
        FROM @AllCampaigns
        WHERE cam_id = @campID
    END
    '
    ...
    @process = 'Se modifica ccsp_GalateaAdminCampaignsSurvey, para obtener campañas de IA'
    @sql = '
