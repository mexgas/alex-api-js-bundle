...
BEGIN
	BEGIN TRAN
	BEGIN TRY
		-------------------- Marco García BEGIN TT10870-Engine-Error mensajes automáticos-------------------

		 set @process = 'TT10870-Engine-Error mensajes automáticos DROP PROCEDURE ccsp_GalateaAgentAutomaticMessages'
		...
		SET @process = 'TT10870-Engine-Error mensajes automáticos create store procedure ccsp_GalateaAgentAutomaticMessages'
		...
		-------------------- Marco García END TT10870-Engine-Error mensajes automáticos-------------------
