pipeline {
    ...
    environment {
        ...
        IS_PUBLISH_FTP = false // true -> copia los archivos a la carpeta del FTP del instalador, false -> no copia nada
    }
    stages {
        ...
        stage('Publish Ftp CCenterRIA') {
            ...
            steps {
                sshPublisher(publishers: [sshPublisherDesc(configName: 'SFTP Dev46', transfers: [
                    ...
                    remoteDirectory: "cw/${env.RELEASE_VERSION}/UpdateDB", remoteDirectorySDF: false,
                ...
                sshPublisher(publishers: [sshPublisherDesc(configName: 'SFTP Dev46', transfers: [
                    ...
                    remoteDirectory: "cw/${env.RELEASE_VERSION}/Database", remoteDirectorySDF: false,
        ...
        stage('Publish Ftp CCReportsRIA') {
            ...
            steps {
                sshPublisher(publishers: [sshPublisherDesc(configName: 'SFTP Dev46', transfers: [
                    sshTransfer(cleanRemote: true, excludes: '', execCommand: '', execTimeout: 120000, flatten: false, makeEmptyDirs: false, noDefaultExcludes: false, patternSeparator: '[, ]+',
                    remoteDirectory: "cw/${env.RELEASE_VERSION}/ReportsRia/UpdateDB", remoteDirectorySDF: false,
                ...
                sshPublisher(publishers: [sshPublisherDesc(configName: 'SFTP Dev46', transfers: [
                    sshTransfer(cleanRemote: false, excludes: '', execCommand: '', execTimeout: 120000, flatten: false, makeEmptyDirs: false, noDefaultExcludes: false, patternSeparator: '[, ]+',
                    remoteDirectory: "cw/${env.RELEASE_VERSION}/ReportsRia/Database", remoteDirectorySDF: false,
        ...
        stage('Publish Ftp AVRS') {
            ...
            steps {
                sshPublisher(publishers: [sshPublisherDesc(configName: 'SFTP Dev46', transfers: [
                    sshTransfer(cleanRemote: true, excludes: '', execCommand: '', execTimeout: 120000, flatten: false, makeEmptyDirs: false, noDefaultExcludes: false, patternSeparator: '[, ]+',
                    remoteDirectory: "cw/${env.RELEASE_VERSION}/AVRS/UpdateDB", remoteDirectorySDF: false,
        ...
        stage('Publish Ftp Jobs') {
            ...
            steps {
                sshPublisher(publishers: [sshPublisherDesc(configName: 'SFTP Dev46', transfers: [
                    sshTransfer(cleanRemote: true, excludes: '', execCommand: '', execTimeout: 120000, flatten: false, makeEmptyDirs: false, noDefaultExcludes: false, patternSeparator: '[, ]+',
                    remoteDirectory: "cw/${env.RELEASE_VERSION}/Jobs", remoteDirectorySDF: false,
                    removePrefix: '/Jobs/',
                    sourceFiles: '/Jobs/*.sql')], usePromotionTimestamp: false, useWorkspaceInPromotion: false, verbose: false)])

                    sshPublisher(publishers: [sshPublisherDesc(configName: 'SFTP Dev46', transfers: [
                    sshTransfer(cleanRemote: true, excludes: '', execCommand: '', execTimeout: 120000, flatten: false, makeEmptyDirs: false, noDefaultExcludes: false, patternSeparator: '[, ]+',
                    remoteDirectory: "cw/${env.RELEASE_VERSION}/SQLTools/", remoteDirectorySDF: false,
        ...
        stage('Publish Ftp Replication') {
            ...
            steps {
                sshPublisher(publishers: [sshPublisherDesc(configName: 'SFTP Dev46', transfers: [
                    sshTransfer(cleanRemote: false, excludes: '', execCommand: '', execTimeout: 120000, flatten: false, makeEmptyDirs: false, noDefaultExcludes: false, patternSeparator: '[, ]+',
                    remoteDirectory: "cw/${env.RELEASE_VERSION}/SQLTools/Replication", remoteDirectorySDF: false,
