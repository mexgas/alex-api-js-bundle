...
Fecha: 2010/00/00
Descripcion: Actualizacion de sp para corregir funcionamiento y se agrega un nuevo setting para amatech.
...
exec(@sql)'
	EXEC(@Sql)
 	...
 	set @Sql='insert into ccsettings (setting_id, valor,descripcion,status,tipo) values (26,''Verde'',''AMATECH nombre centro que representa'',1,''RPT'')'
	EXEC(@Sql)
