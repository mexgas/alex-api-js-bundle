...
isnull([textInput1],'') AS [textInput1],isnull([textInput2],'') AS [textInput2],isnull([textInput3],'') AS [textInput3] from(
						...
						B.componentId  IN('textInput1','textInput2','textInput3')
						...
						pivot(
						MAX(dataValue)
						FOR componentId IN([textInput1],[textInput2],[textInput3])
						)as PivoTable