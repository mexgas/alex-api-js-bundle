...
SonarScanner.MSBuild.exe begin /k:"%NameSpace%" /d:sonar.host.url="http://localhost:9000" /d:sonar.login="%tokenSonar%" /d:sonar.cs.opencover.reportsPaths=Coverge.xml 
MSBuild.exe "%NameSpace%.Solution.sln" /t:clean;rebuild  /p:Configuration=Debug
