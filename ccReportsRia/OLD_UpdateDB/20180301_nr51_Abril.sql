...
drop view RepViewAgentGISpecial
	...
	set @process = 'CW-1335 -- VERSION 49  DROP FUNCTION fnGetTipoLlamada IF IT EXISTS'
    set @Sql= 'IF object_id(N''dbo.fnGetTipoLlamada'', N''FN'') IS NOT NULL
	DROP FUNCTION dbo.fnGetTipoLlamada'
	EXEC(@Sql)
...
END'
	...
	set @process = 'CW-1335 -- VERSION 49  CREATE FUNCTION fnGetTipoLlamada'
    set @Sql= 'CREATE function [dbo].[fnGetTipoLlamada]( @tel varchar(20) )
returns int
as
 begin
