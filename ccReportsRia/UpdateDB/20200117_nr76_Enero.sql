...
BEGIN
	...
	BEGIN TRY
		...
		SET @process = 'CW-3427 Insert de las columnas calKey y telephone en RepOutManagementBase'
		SET @sql = 'IF NOT EXISTS
(
    SELECT *
    FROM INFORMATION_SCHEMA.COLUMNS
    WHERE COLUMN_NAME = ''calKey''
          AND TABLE_NAME = ''RepOutManagementBase''
)
    BEGIN
        ALTER TABLE RepOutManagementBase
        ADD calKey VARCHAR(20);
END
...
END'
		...
		SET @process = 'CW-3427 se modifica el sp ccspRepOutManagementBase'
