...
SET @version = 149 --**********actualizar a 124 sin fix
...
------------------------------------ BEGIN Pavel ------------------------------------
    ...
    SET @process = 'CW-10665 - Se realiza ajuste para permitir la generación de la réplica nuevamente ';
    SET @sql = '
