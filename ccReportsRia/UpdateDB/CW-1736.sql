...
BEGIN
	INSERT INTO ReportsTotals values(7130, ''avg:avrAnswer|sum:acdCalls|avg:avgAbandonTime|avg:tPromACD|avg:tPromACW|sum:abandonedCalls|max:maxDelay|sum:entryFlow|sum:outFlow|sum:callsOutExt|avg:tPromSalidaExt|sum:callsDeleteQue|avg:tPromElimCola'')
END'
	EXEC(@Sql)
