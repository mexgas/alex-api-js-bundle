...
BEGIN
	INSERT INTO ReportsTotals values(7140, ''avg:avrAnswer|avg:avgAbandonTime|sum:acdCalls|avg:tPromACD|avg:tPromACW|sum:abandonedCalls|max:maxDelay|sum:entryFlow|sum:outFlow|sum:callsOutExt|avg:tPromSalidaExt|sum:callsDeleteQue|avg:tPromElimCola|avg:avrTimeACD|avg:avrCallsAnswer|avg:PromPosicionPersonal|avg:LlamadasporPosicion'')
END'
	EXEC(@Sql)
