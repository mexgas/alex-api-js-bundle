...
BEGIN
	...
	---------------------------------------BEGIN Jesus Gallardo Milla -----------------------------------------------------------
	SET @process = 'Alter SP ccspRepOutDialDetail Se valida DC_Extra esta vacia no haga busqueda no necesarias'
...
--Inserta informacon de reporte  
    INSERT INTO RepOutDialDetail
        ...
        ,ISNULL(dials.[cam_id],0)campaignId
